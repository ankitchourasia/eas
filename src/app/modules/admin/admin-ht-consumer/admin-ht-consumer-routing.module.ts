...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: '33kv/read/view/absent',component: AdminHTConsumer33KVReadingViewAbsentComponent,
      },
      {
        path: '33kv/read/upload',component: AdminHTConsumer33KVReadUploadComponent,
      },
      { 
