...
@Directive({
    ...
    providers: [{ provide: NG_VALIDATORS, useExisting: forwardRef(() => CompareValidatorDirective), multi: true }]
})
export class CompareValidatorDirective implements Validator {
  
    constructor(@Attribute('compareEqual') public compareEqual: string, @Attribute('reverse') public reverse: string) {}
