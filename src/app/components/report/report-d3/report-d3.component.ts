...
export class ReportD3Component implements OnInit {
  ...
  viewByTownIdAndBillMonth(){
    ...
    this.viewResultList = [];
    this.reportService.getD3ByTownIdAndBillMonth(this.searchFormData.town.id, this.searchFormData.billMonth, false).subscribe(successResponse =>{
  ...
  exportClicked(exportElementId){
    ...
    let fileUrl = GlobalConfiguration.URL_PREFIX_FOR_FILE_EXPORT + "report/d3-report/export/town/id/" + this.searchFormData.town.id + "/bill-month/" + this.searchFormData.billMonth;
