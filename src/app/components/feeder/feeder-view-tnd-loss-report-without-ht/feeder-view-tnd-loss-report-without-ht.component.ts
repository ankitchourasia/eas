...
@Component({
  ...
  templateUrl: './feeder-view-tnd-loss-report-without-ht.component.html',
  styleUrls: ['./feeder-view-tnd-loss-report-without-ht.component.css']
})
export class FeederViewTndLossReportWithoutHtComponent implements OnInit {
