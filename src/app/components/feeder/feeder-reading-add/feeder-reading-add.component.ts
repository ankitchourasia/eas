    ...
    if(this.feederMeterReplacement){
      if(this.feederReading.currReading >= 0 && this.feederReading.prevReading >= 0 && this.feederReading.newMeterStartRead >= 0 && this.feederReading.finalRead >= 0 && 
        ...
        this.feederReading.finalRead >= this.feederReading.prevReading){
          this.feederReading.oldReadingDifference = (Number.parseFloat(this.feederReading.finalRead) - Number.parseFloat(this.feederReading.prevReading)).toFixed(2);
          this.feederReading.oldMeterConsumption = Number.parseFloat(this.feederReading.oldReadingDifference) * Number.parseFloat(this.feederReading.mf);
          this.feederReading.newReadingDifference = (Number.parseFloat(this.feederReading.currReading) - Number.parseFloat(this.feederReading.newMeterStartRead)).toFixed(2);
          this.feederReading.newMeterConsumption = Number.parseFloat(this.feederReading.newReadingDifference) * Number.parseFloat(this.feederReading.newMf);
          this.feederReading.readingDiff = Number.parseFloat(this.feederReading.oldReadingDifference) + Number.parseFloat(this.feederReading.newReadingDifference);
